      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-24 grid gap-8 md:grid-cols-3">
          {steps.map((step, i) => (
            <div
              key={i}
              className="border-lb group border p-10 text-center transition-all duration-700 ease-out hover:border-[var(--lb-black)]"
            >
              <span className="mb-6 block font-serif text-2xl italic text-[var(--lb-black)] opacity-20 transition-opacity group-hover:opacity-100">
                0{i + 1}
              </span>
              <h3 className="mb-4 text-[11px] font-bold uppercase tracking-[0.2em] text-[var(--lb-black)]">
                {step.title}
              </h3>
        ...
        <div className="border-lb mx-auto max-w-2xl border-t pt-20">
          <div className="text-center">
            <h2 className="mb-6 font-serif text-2xl text-[var(--lb-black)]">
              Return Policy
            </h2>
            ...
            <a
              href="/contact"
              className="inline-block border border-[var(--lb-black)] px-10 py-4 text-[10px] font-medium uppercase tracking-[0.3em] transition-all duration-500 hover:bg-[var(--lb-black)] hover:text-[var(--lb-white)]"
            >
